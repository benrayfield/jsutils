...
/*
	...
	*/
	...
	im keeping it cuz it makes my browser performance tools get correct measurements.
	*/
	...
	//vm.glCanvasHeight = 75;
	//vm.glCanvasWidth = 100;
	vm.setBootOptionsInGl = gl=>{
		//so it ignores .w in vec4(red,green,blue,depth), doesnt use it as transparency, in graphicsMain and graphicsDebug and todo graphicsOverlay.
		gl.disable(gl.BLEND);
	};
	vm.Gl = ()=>{
		if(!vm.gl){
