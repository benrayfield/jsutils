...
//copied from Bellsack468.html LamglFromBellsack468.js 2026-5-2.
...
/*
	...
	* 2026-2-9 or earlier [HALF DONE] workaround for 3d surface occurring around a 3d volume. should be 2d surface. makes some walls wavy and search for nearest point on surface keep looking deeper into that "3d surface" instead of stopping at a "2d surface" it should be. The fix was to change ns.Opt.AddToDensityForTesting.p from 0 to 0.01 or 0.05 etc.
...
void main(){
	...
	//returns [] list of GLVar's in the order they should be used in gl. Call this as Lamgl.glvars(paramUrAboutToUseInLamgl);
